...
use App\Filament\Plugins\LocaleSwitcher\Middleware\SetPanelLocale;
...
{
    protected string $renderHook = PanelsRenderHook::SIDEBAR_FOOTER;
    ...
    public function register(Panel $panel): void
    {
        $panel->renderHook(
            ...
            hook: function (): View {
                ...
                return view('filament.plugins.locale-switcher.dropdown', compact(
                    'otherLanguages',
                    'currentLanguage',
                    'showFlags',
                ));
    ...
    protected function getFilamentLocales(): array
    {
        ...
        foreach ($directories as $directory) {
            ...
            if (in_array($localeCode, ['vendor', 'admin'])) {
                continue;
            }
